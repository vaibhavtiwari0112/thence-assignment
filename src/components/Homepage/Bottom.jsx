...
import QuestionsAndAnswers from "../../data/QuestionAnswers";

const Bottom = () => {
  const [answersVisible, setAnswersVisible] = useState(
    new Array(QuestionsAndAnswers.length).fill(false)
  );
      ...
      <div className="bottom-container">
        <div className="left-side">
          <div className="left-side-text">
            <div className="left-side-text-1">What's on your mind</div>
            <div className="left-side-text-2">Ask Questions</div>
          </div>
